...
const SearchBar = ({ onSearch }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (showAdvanced) {
      ...
      if (advancedFilters.from) advancedQuery += ` from:${advancedFilters.from}`;
      if (advancedFilters.to) advancedQuery += ` to:${advancedFilters.to}`;
      if (advancedFilters.subject) advancedQuery += ` subject:${advancedFilters.subject}`;
      if (advancedFilters.hasAttachment) advancedQuery += ' has:attachment';
